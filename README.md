...
- У треков: длительность из файла, текст песни, опциональная минусовка, обложка из тегов mp3
...
3. **Минус** — необязательный аудиофайл. Если загружен, на сайте появляется кнопка «Минус» и запускает минусовку.
4. **Обложка** подтягивается из встроенной картинки mp3 (ID3 APIC), если она есть. Свою картинку по-прежнему можно загрузить вручную — она имеет приоритет.
